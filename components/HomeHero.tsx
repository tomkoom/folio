    ...
    <header className="mb-10 sm:mb-12 lg:mb-14">
      ...
      <p className="max-w-2xl text-sm lowercase leading-relaxed text-gray-400 sm:text-base">
        <span className="block sm:inline">
          ...
          prediction markets, automation tools, ai agent workflows, and realtime
          data apps.
        </span>{" "}
        <span className="mt-2 block sm:mt-0 sm:inline">
          experienced with on-chain integrations, apis, price feeds, realtime
          logic, and building automation layers that connect agents, services,
          and user-facing products — delivered with production-ready typescript
          stacks.
        </span>
      </p>
    </header>
